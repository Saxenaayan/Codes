...
def count_tokens(text, model_name):
    """
    Counts the tokens in a given text using tiktoken.

    Args:
        text: The text to tokenize.
        model_name: The model used to generate the text
...
async def generate_uml(request: UMLRequest):
    ...
    PlantUML:
    """
    input_tokens = count_tokens(full_prompt, request.model)
    response_tokens = count_tokens(plantuml_code+ text_response + diagram_description, request.model)
