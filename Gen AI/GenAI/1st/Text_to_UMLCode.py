...
def generate_plantuml_gemini(text_description,pyton  model_name="gemini-pro"):
    """
...
if __name__ == "__main__":
    text_input = input("Enter a text description of a system or relationship: ")
    plantuml = generate_plantuml_gemini(text_input)

    if plantuml.startswith("Error"):
      print(plantuml)
    else:
      print("\nGenerated PlantUML:\n")
      print(plantuml)
      print("\nTo convert to an image, go to https://www.planttext.com/ and paste the code in.")